...
DELETE FROM TicketNameserver WHERE T_Number IN (SELECT T_Number FROM Ticket WHERE D_Name LIKE 'uc018%');
DELETE FROM TicketNameserverHist WHERE T_Number IN (SELECT T_Number FROM Ticket WHERE D_Name LIKE 'uc018%');
DELETE FROM Ticket WHERE D_Name LIKE 'uc018%';
DELETE FROM TicketHist WHERE D_Name LIKE 'uc018%';
