(function($) {
    ...
    // setup and teardown functions have to be defined, because jQuery in the currently used version (1.2.6) will try to
    // call them no matter if they are defined or not.
