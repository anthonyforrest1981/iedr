 ...
 */
if(/*!Yii::app()->user->isGuest and*/ (Utility::getPermission() != UserPermissionLevel::UNDEFINED) && Utility::isInternalNetwork() && NicHandleIdentity::canSwitchAccounts()) {
    $switchmodel = new UserSwitchModel();
    $form = $this->beginWidget('CActiveForm', array('method' => 'POST','id' => 'userswitch_form',
        'action' => $switchmodel->getSwitchActionUrl(),'enableAjaxValidation' => false));
