 ...
 */
class jqGridComandButtonsWidget extends CWidget {
    /**
    ...
    var $commandlist;
    /**
     * an label for this command-button form, required when there are multiple command-button forms rendered in the same view, to facilitate multiple jqGridComandButtonsWidget instances in the same page.
     * defaults to 'gridaction'.
     *
     * @var string
     * @access public
     */
    ...
    var $pk_column_index;
    /**
     * Marks whether command buttons gets disabled
     *
     * @var boolean
     * @access public
     */
