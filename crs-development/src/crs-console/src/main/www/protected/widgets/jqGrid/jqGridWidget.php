...
class jqGridWidget extends CWidget {
    ...
    /**
     * @var string identifier of the grid instance, useful for e.g. remembering different perPage for each grid
     */
    public $gridId = "grid";
    /**
     * Grid Caption
     ...
     */
    public function run() {
        $this->render('application.widgets.jqGrid.view', array('gridId' => $this->gridId, 'caption' => $this->caption,
            'thisfile' => $this->thisfile,'datasource' => $this->datasource,'datastr' => $this->datastr,
            'datatype' => $this->datatype,'numrows' => $this->numrows,'allowAll' => $this->allowAll,
            'tableId' => $this->tableId,'navGrid' => $this->navGrid,'pager' => $this->pager,
