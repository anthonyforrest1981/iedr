...
<li class="document_upload">
    ...
    <div class="uploaded_file_details">
        ...
        <div class="file_assign"<?php if (!$multipleDomains): ?> style="display: none"<?php endif; ?>>
...
<div>
    <h3 style="font-size: 1em; font-weight: bold;">Supporting Documents</h3>
</div>
<div>
    Selected <span databind="documents_counter">0</span> of <span
        databind="documents_count_limit"></span> allowed documents.
