...
class ViewTodayDepositReservationModel extends GridModelBase {
    ...
    public function __construct() {
        $this->columns = array(
            'A' => array('label' => 'Domain','resultfield' => 'domainName','criteriafield' => 'domainName',
                'width' => 17,'link' => 'domains/viewdomain'),
            'O' => array('label' => 'Reservation Type','width' => 10,'resultfield' => 'operationType',
            ...
            'B' => array('label' => 'Duration','resultfield' => 'durationMonths','width' => 6),
            'C' => array('label' => 'Creation Date','resultfield' => 'creationDate','width' => 10),
            'D' => array('label' => 'Fee Amount','resultfield' => 'amount','width' => 10,'type' => 'currency'),
            'E' => array('label' => 'Vat Amount','resultfield' => 'vatAmount','width' => 9,'type' => 'currency'),
            'F' => array('label' => 'Total Amount','resultfield' => 'total','width' => 10,'type' => 'currency'),
            'G' => array('label' => 'Order ID','resultfield' => 'orderId','width' => 12),
            'H' => array('label' => 'Ticket','resultfield' => 'ticketId','width' => 7),
            'J' => array('label' => 'Financial Status','resultfield' => 'financialStatus','width' => 10));
    }
    ...
    public function addResults($o) {
        ...
        return array('A' => $o->domainName,'O' => $o->operationType,'B' => ($o->durationMonths / 12),
            'C' => parseXmlDate($o->creationDate),'D' => number_format($o->netAmount, 2),
            'E' => number_format($o->vatAmount, 2),'F' => number_format($o->total, 2),'G' => $o->orderId,
            'H' => $o->ticketId,'J' => $o->financialStatus);
    }
