...
class DepositTopUpHistoryModel extends GridModelBase {
    ...
    public $columns = array(
        'A' => array('label' => 'Date','resultfield' => 'operationDate','criteriafield' => null,'width' => 20,
            'type' => null),
        'B' => array('label' => 'Top Up Amount','resultfield' => 'topUpAmount','criteriafield' => null,'width' => 20,
            'type' => 'currency'),
        'C' => array('label' => 'Order ID','resultfield' => 'orderId','criteriafield' => null,'width' => 20,
            'type' => null),
        'D' => array('label' => 'Closing Balance','resultfield' => 'closingBalance','criteriafield' => null,
            'width' => 20,'type' => 'currency'));

    public function rules() {
        return array(array('searchParams','validateSearchParams'));
    }
...
($daysInt > 0) and ($daysInt <= 999)) {
    ...
    public function addResults($o) {
        ...
        return array('A' => parseXmlDate($o->operationDate),'B' => number_format($o->topUpAmount, 2),'C' => $o->orderId,
            'D' => number_format($o->closingBalance, 2));
    }

    public function getSearchBase() {
        return array('fromDate' => date('Y-m-d', time() - 86400 * $this->getDays()),'toDate' => date('Y-m-d', time()));
    }
