...
class RegistrarDetailsModel extends CFormModel {
    ...
    public function __construct() {
        ...
        $this->defaultRows = $appConfig->nameserversMinCount;
    ...
    public function rules() {
        return array(array('techContact,emailInvoiceFormat','required'),
            array('techContact,emailInvoiceFormat','Utf8Validator'),
            array('techContact','filter','filter' => 'mb_strtoupper'),array('techContact','NicHandleValidator'),
    ...
    public function attributeLabels() {
        return array('techContact' => 'Tech Contact','dnsNotificationPeriod' => 'Dns Notification Period',
