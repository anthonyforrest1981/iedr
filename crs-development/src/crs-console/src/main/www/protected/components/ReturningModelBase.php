 ...
 * @see References to other sections (if any)...
 */
class ReturningModelBase extends FormModelBase {
    /**
     ...
     *
     * @param array $arr
     *            array to copy data from, having the same keys as {@link returningData}
     ...
     *
     * @param array $arr
     *            array containing an array whose key is 'returningData'
