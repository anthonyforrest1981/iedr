...
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'todayDepositReservation',
    ...
    'datasource' => $this->createUrl('account_today_deposit_reservations/getgriddataDepositBalanceReady', array(
        'model' => $model_serialised)),'model' => $model));
?>
