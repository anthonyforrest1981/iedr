...
$commandlist = array();
if (!Utility::isDirect()) {
    if ($model->renewalDateType == 'OVERDUE') {
...
GridUtility::makeCurrenRenewalsOption($this, $pg, 'account_current_renewals', $model);
$this->widget('application.widgets.jqGrid.jqGridComandButtonsWidget', array('pk_column_index' => 0,
    ...
    'returnurl' => $this->createUrl('account_current_renewals/menu'),'formid' => 'gridactionpay',
    'commandlist' => $commandlist));
echo '<br/>';
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'currentRenewals',
    ...
    'model' => $model,'searching' => true,'sorting' => true,'selections' => true));
?>
