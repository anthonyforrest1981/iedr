...
$form = $this->beginWidget('CActiveForm', array('id' => 'change-password','enableAjaxValidation' => false));
...
<center>
    ...
    <div class="row">
      ...
      <?php echo $form->passwordField($model,'new_password',array('size'=>20, 'maxlength'=>'')); ?>
      <?php echo $form->error($model,'new_password'); ?>
    </div>
    <div class="row">
      <?php echo $form->labelEx($model,'repeat_new_password'); ?>
      <?php echo $form->passwordField($model,'repeat_new_password',array('size'=>20, 'maxlength'=>'')); ?>
