...
if (!Utility::isDirect()) {
    $commandlist = array('payonline' => 'Pay %n Domains Online (%fee €)',
        'paydeposit' => 'Pay %n Domains From Deposit (%fee €)','voluntary' => 'Put %n Domains into Voluntary NRP',
...
$this->widget('application.widgets.jqGrid.jqGridComandButtonsWidget', array('pk_column_index' => 0,
    ...
    'returnurl' => $this->createUrl('account_future_renewals_by_month/menu'),'commandlist' => $commandlist));
echo '<br/>';
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'futureRenewals',
    ...
    'datasource' => $this->createUrl('account_future_renewals_by_month/getgriddatacurrrnr', array(
        'model' => $model_serialised)),'model' => $model,'searching' => true,'sorting' => true,'selections' => true));
?>
