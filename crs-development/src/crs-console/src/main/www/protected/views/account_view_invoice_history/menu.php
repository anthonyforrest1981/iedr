...
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'invoiceHistory',
    ...
    'datasource' => $this->createUrl('account_view_invoice_history/getgriddata_invoices', array(
