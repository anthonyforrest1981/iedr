...
$w = $this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'tickets',
    'caption' => 'Tickets for \'' . Yii::app()->user->name . '\'',
    'thisfile' => $this->createUrl('tickets/menu', array('model' => $model_serialised)),
    'datasource' => $this->createUrl('tickets/getgriddata', array('model' => $model_serialised)),'model' => $model,
    'searching' => true,'sorting' => true,'allowAll' => true));
?>
