...
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'nicNameSearch',
    'caption' => 'All accounts registered with \'' . Yii::app()->user->name . '\'',
    'thisfile' => $this->createUrl('contacts/namesearch', array('model' => $model_serialised)),
    'datasource' => $this->createUrl('nicsearch/getgriddata', array('model' => $model_serialised)),'model' => $model,
    'searching' => true,'sorting' => true,'selections' => false,'get_nic_handle' => true));
?>
