...
$this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'depositTopups',
    'caption' => $pg . ' for \'' . Yii::app()->user->name . '\'',
    'thisfile' => $this->createUrl('account_view_deposit_topups/menu', array('model' => $model_serialised)),
    'datasource' => $this->createUrl('account_view_deposit_topups/getGridDataTopUpHistory', array(
        'model' => $model_serialised)),'model' => $model,'searching' => false,'sorting' => false,'selections' => false));
?>
