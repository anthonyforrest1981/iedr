...
?>
<p>To modify a domain's DNS details use the grid to search and select
    domain(s) and then click on the DNS modification button.</p>
<?php
...
$this->widget('application.widgets.jqGrid.jqGridComandButtonsWidget', array('pk_column_index' => 1,
    'actionurl' => $this->createUrl('dns/dnsupdate'),'returnurl' => $this->createUrl('nsreports/dnsserversearch'),
    'commandlist' => array('dnsMod' => 'Modify DNS for selected Domains')));
echo '<br/>';
$w = $this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'dnsSearch',
