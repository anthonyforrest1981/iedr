...
$this->widget('application.widgets.jqGrid.jqGridComandButtonsWidget', array('pk_column_index' => 0,
    'actionurl' => $this->createUrl('newdomains/confirm'),
    'returnurl' => $this->createUrl('newdomains/view'),
    'commandlist' => array('autorenew' => 'Set %n Domains Autorenew')));
echo '<br/>';
$w = $this->widget('application.widgets.jqGrid.jqGridWidget', array('gridId' => 'newDomains',
    'caption' => 'New Domains registered with \'' . Yii::app()->user->name . '\'',
    'thisfile' => $this->createUrl('newdomains/view', array('model' => $model_serialised)),
    'datasource' => $this->createUrl('newdomains/getgriddata', array('model' => $model_serialised)),
