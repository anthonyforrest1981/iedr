...
<div class="form">
    ...
    $form = $this->beginWidget('CActiveForm', array('id' => 'ViewRegistraForm','enableAjaxValidation' => true));
    ?>
    <table border="1" class="formfields">
        <tbody>
            <tr>
                ...
                <td>
                    <div class="row"><?php echo $form->textField($model, 'techContact'); nicHandleWidget($this, 'techContact', 'techContact1', 'tech'); ?></div>
                </td>
            </tr>
            <tr>
                <td>
                ...
                $this->widget('application.widgets.nameservers.nameserversWidget',
                    array('form' => $form,'model' => $model, 'dnsCheck' => false));
                ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row"><?php echo $form->textField($model, 'dnsNotificationPeriod', array('maxlength' => 2, 'size' => 2)); ?></div>
                </td>
            </tr>
            <tr>
                <td>
                <?php
echo $form->labelEx($model, 'emailInvoiceFormat');
                echo $form->error($model, 'emailInvoiceFormat');
                ?></td>
                <td>
                    <div class="row"><?php echo $form->radioButtonList($model, 'emailInvoiceFormat', Utility::getEmailInvoiceTypes(), array('size' => '40', 'separator' => ' ', 'labelOptions' => array('style' => 'display:inline')));?></div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
