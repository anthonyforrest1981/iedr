...
ALTER TABLE `Account` CHANGE COLUMN `A_Status_Dt` `A_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Account` CHANGE COLUMN `A_Reg_Dt` `A_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `AccountHist` CHANGE COLUMN `A_TStamp` `A_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `AccountHist` CHANGE COLUMN `A_Status_Dt` `A_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `AccountHist` CHANGE COLUMN `A_Reg_Dt` `A_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `AccountHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `Deposit` CHANGE COLUMN `Trans_Dt` `Trans_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `DepositHist` CHANGE COLUMN `Trans_Dt` `Trans_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `DepositHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `DNS_Check_Notification_Date` CHANGE COLUMN `Next_Notification_Date` `Next_Notification_Dt` DATE NOT NULL;

ALTER TABLE `Domain` CHANGE COLUMN `D_TStamp` `D_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Domain` MODIFY COLUMN `D_Reg_Dt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `Domain` CHANGE COLUMN `D_Reg_Dt` `D_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `DomainHist` CHANGE COLUMN `D_TStamp` `D_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `DomainHist` MODIFY COLUMN `D_Reg_Dt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `DomainHist` CHANGE COLUMN `D_Reg_Dt` `D_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `DomainHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `Email` CHANGE COLUMN `E_TS` `E_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
UPDATE `EmailHist` SET `Chng_Dt` = @timestamp_start WHERE `Chng_Dt` < @timestamp_start;
ALTER TABLE `EmailHist` CHANGE COLUMN `E_TS` `E_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `EmailHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `EmailDisabler` CHANGE COLUMN `ED_TS` `ED_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
UPDATE `EmailDisablerHist` SET `Chng_Dt` = @timestamp_start WHERE `Chng_Dt` < @timestamp_start;
ALTER TABLE `EmailDisablerHist` CHANGE COLUMN `ED_TS` `ED_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `EmailDisablerHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `EmailGroup` CHANGE COLUMN `EG_TS` `EG_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
UPDATE `EmailGroupHist` SET `Chng_Dt` = @timestamp_start WHERE `Chng_Dt` < @timestamp_start;
ALTER TABLE `EmailGroupHist` CHANGE COLUMN `EG_TS` `EG_Change_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `EmailGroupHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `INCOMING_DOC` CHANGE COLUMN `CR_DATE` `Create_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

UPDATE `Invoice` SET `Invoice_Date` = @timestamp_start WHERE `Invoice_Date` IS NULL;
ALTER TABLE `Invoice` CHANGE COLUMN `Invoice_Date` `Invoice_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `LoginAttempts` CHANGE COLUMN `attempted` `attempted_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `NicHandle` CHANGE COLUMN `NH_Status_Dt` `NH_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `NicHandle` CHANGE COLUMN `NH_Reg_Dt` `NH_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `NicHandle` CHANGE COLUMN `NH_TStamp` `NH_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `NicHandleHist` CHANGE COLUMN `NH_TStamp` `NH_Change_TS`TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `NicHandleHist` CHANGE COLUMN `NH_Status_Dt` `NH_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `NicHandleHist` CHANGE COLUMN `NH_Reg_Dt` `NH_Reg_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `NicHandleHist` CHANGE COLUMN `Chng_Dt` `Chng_TS`TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `PersistedCommands` CHANGE COLUMN `P_CreateDate` `P_Create_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `ResellerDefaultNameservers` MODIFY COLUMN `RDN_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

UPDATE `Reservation` SET `Creation_Date` = @timestamp_start WHERE `Creation_Date` < @timestamp_start;
ALTER TABLE `Reservation` CHANGE COLUMN `Creation_Date` `Creation_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `ReservationHist` CHANGE COLUMN `Creation_Date` `Creation_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `ResetPass` CHANGE COLUMN `Time_Stamp` `Expires_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

UPDATE `SchedulerJob` SET `start_date` = CURRENT_TIMESTAMP WHERE `start_date` IS NULL;
ALTER TABLE `SchedulerJob` CHANGE COLUMN `start_date` `start_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `SchedulerJobHist` CHANGE COLUMN `start_date` `start_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `SchedulerJobHist` CHANGE COLUMN `end_date` `end_TS` TIMESTAMP NULL;

ALTER TABLE `Ticket` CHANGE COLUMN `T_TStamp` `T_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `Ticket` MODIFY COLUMN `T_Created_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Ticket` CHANGE COLUMN `Ad_StatusDt` `Ad_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Ticket` CHANGE COLUMN `T_Status_Dt` `T_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Ticket` CHANGE COLUMN `F_Status_Dt` `F_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `Ticket` CHANGE COLUMN `C_Status_Dt` `C_Status_TS`TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `T_TStamp` `T_Change_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `TicketHist` MODIFY COLUMN `T_Created_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `Ad_StatusDt` `Ad_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `T_Status_Dt` `T_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `F_Status_Dt` `F_Status_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `C_Status_Dt` `C_Status_TS`TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketHist` CHANGE COLUMN `Chng_Dt` `Chng_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `TicketNameserver` MODIFY COLUMN `TN_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `TicketNameserverHist` MODIFY COLUMN `TN_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

UPDATE `TransfersHist` SET `Tr_Date` = @timestamp_start WHERE `Tr_Date` < @timestamp_start;
ALTER TABLE `TransfersHist` CHANGE COLUMN `Tr_Date` `Transfer_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
