...
// Covering Test Ref: 1.1.1.17
//retired test case as NASK say this is not implemented (set defaults for domainCreate) have to verify this

class DomainRegXYZWithDefaults extends IEDR_BPR_Test {
    ...
    public function testDomainCreateSuccess() {
        ...
        $command = new DomainCreateCommand("withdefaults.ie");
    ...
    public function testDomainCreateSucessDbTest() {
        ...
        $arr = DBUtils::getTicketData("withdefaults.ie", "1");
        ...
        $this->assertEquals($dom, 'withdefaults.ie');
