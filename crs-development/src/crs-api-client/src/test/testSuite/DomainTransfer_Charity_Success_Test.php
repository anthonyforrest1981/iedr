...
//test ref: 1.6.1.2
class DomainTransferCharityState extends IEDR_BPR_Test_II {
    ...
    $command = new DomainTransferCommand("example0581.ie");
...
$arr = DBUtils::getTicketData("example0581.ie", "1");
...
$this->assertEquals($dom , 'example0581.ie');
           $this->assertEquals($type, 'Transfer');
           $this->assertEquals($owner, 'XNV498-IEDR');
           $this->assertEquals($holder, 'Test Holder 0581');
