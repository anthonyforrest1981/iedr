...
class DomainTransferSuccessINRP extends IEDR_BPR_Test_II

    //test ref: 1.6.1.10

{

    //Test: Domain in invol. NRP being xferred.
    ...
    public function testDomainTransfer() {
        ...
        $command = new DomainTransferCommand("example0545.ie");
    ...
    public function testDomainTransferDbTest() {
        ...
        $arr = DBUtils::getTicketData("example0545.ie", "5");
        ...
        $this->assertEquals($dom, 'example0545.ie');
        $this->assertEquals($type, 'Transfer');
        $this->assertEquals($owner, 'XNV498-IEDR');
        $this->assertEquals($holder, 'Test Holder 0545');
    ...
    public function testDomainTransferDbTest2() {
        ...
        $arr = DBUtils::getState("example0545.ie");

        $state = $arr['State'];

        $this->assertEquals($state, '438');
