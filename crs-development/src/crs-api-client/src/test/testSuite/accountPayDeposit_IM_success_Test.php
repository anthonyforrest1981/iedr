...
class AccountPayDepositIM1Year extends IEDR_BPR_Test {

    /**
     * @group PaymentSuccess
     */
    public function testAccountPayIM1Year() {
    ...
    /**
     * @depends testAccountPayIM1Year
     * @group PaymentSuccessDbTest
     */
    public function testAccountPayIM1YeardbTest() {

        $domain= 'example0987.ie';
        $arr = DBUtils::getAccountPayStatus("XBC189-IEDR", $domain, "RM1Yr", "renewal", "Deposit");
     ...
     * @group PaymentSuccessDbTest
     */
    public function testAccountPayIM1YeardbTest2() {

        $arr = DBUtils::getState("example0987.ie");
