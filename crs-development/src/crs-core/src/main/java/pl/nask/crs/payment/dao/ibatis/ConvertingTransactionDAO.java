 ...
 */
public class ConvertingTransactionDAO extends ConvertingGenericDAO<InternalTransaction, Transaction, Long> implements
        TransactionDAO {

    InternalTransactionIbatisDAO internalDAO;

    public ConvertingTransactionDAO(InternalTransactionIbatisDAO internalDAO,
