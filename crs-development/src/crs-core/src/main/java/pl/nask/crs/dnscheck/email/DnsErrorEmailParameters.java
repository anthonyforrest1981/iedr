...
public class DnsErrorEmailParameters implements EmailParameters {
    ...
    public DnsErrorEmailParameters(String domainName, String nsName, String errorMessage, String username,
            String nicHandle) {
    ...
    public List<ParameterName> getParameterNames() {
        return Arrays.<ParameterName>asList(ParameterNameEnum.DOMAIN, ParameterNameEnum.DNS1,
