...
public class DomainListEmailParams implements EmailParameters {
    ...
    private Contact billingC;
    private Contact adminC;
    private List<Domain> domainList;

    public DomainListEmailParams(String username, Contact billingC, Contact adminC, List<Domain> domainList) {
        this.username = username;
        this.billingC = billingC;
        this.adminC = adminC;
    ...
    public List<? extends ParameterName> getParameterNames() {
        return Arrays.<ParameterName>asList(ParameterNameEnum.DOMAIN_LIST,
                ParameterNameEnum.DOMAIN_TABLE_WITH_AUTHCODES, ParameterNameEnum.ADMIN_C_EMAIL,
                ParameterNameEnum.BILL_C_EMAIL, ParameterNameEnum.AUTHCODE_EXP_DATE);
    }
