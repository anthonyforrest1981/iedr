...
public class CreateAccountContener {
    ...
    public CreateAccountContener(String name, String webAddress, String billingContactNicHandle,
            String hostmastersRemark, boolean agreementSigned, boolean ticketEdit) {
        ...
        account = new Account(name, billingContact, AccountStatus.Active, webAddress, hostmastersRemark, nowDate,
                nowDate, nowDate, agreementSigned, ticketEdit);
    }
