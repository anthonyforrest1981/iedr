...
public class ExtendedDomainInfo {
    ...
    public void setRelatedDomainNames(Collection<String> relatedDomainNames) {
        this.relatedDomainNames = relatedDomainNames == null ? Collections.EMPTY_SET : new TreeSet<String>(
                relatedDomainNames);
    }

    @SuppressWarnings("unchecked")
    public void setPendingDomainNames(Collection<String> pendingDomainNames) {
        this.pendingDomainNames = pendingDomainNames == null ? Collections.EMPTY_SET : new TreeSet<String>(
                pendingDomainNames);
    }
