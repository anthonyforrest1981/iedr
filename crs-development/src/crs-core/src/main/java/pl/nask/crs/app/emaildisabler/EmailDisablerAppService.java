...
public interface EmailDisablerAppService {
     ...
     */
    List<EmailDisabler> getAllFor(AuthenticatedUser user) throws AccessDeniedException;
     ...
     */
    List<EmailDisabler> getAllOfEmailGroup(AuthenticatedUser user, long groupId) throws AccessDeniedException;
     ...
     */
    List<EmailDisabler> getAllOfTemplate(AuthenticatedUser user, int templateId) throws AccessDeniedException;
     ...
     */
    List<EmailDisablerSuppressInfo> modifySuppressionMode(AuthenticatedUser user,
            List<EmailDisablerSuppressInfo> emaildisablerInfo) throws AccessDeniedException;
}
