...
public class EmailDisablerAppServiceImpl implements EmailDisablerAppService {
    ...
    public List<EmailDisabler> getAllFor(AuthenticatedUser user) throws AccessDeniedException {
    ...
    public List<EmailDisablerSuppressInfo> modifySuppressionMode(AuthenticatedUser user,
