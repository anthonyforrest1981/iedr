...
public class BulkTransferRequest {
    ...
    private List<BulkTransferDomain> requestedDomains;
    ...
    public List<BulkTransferDomain> getRequestedDomains() {
        return requestedDomains;
    }

    public void setRequestedDomains(List<BulkTransferDomain> requestedDomains) {
    ...
    public Set<String> getDomainNames() {
        ...
        for (BulkTransferDomain d : requestedDomains) {
            requestedDomainsSet.add(d.getName());
        }
