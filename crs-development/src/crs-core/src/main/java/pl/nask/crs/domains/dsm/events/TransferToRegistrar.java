...
public class TransferToRegistrar extends AbstractTransferEvent {
    public TransferToRegistrar(Ticket t, PaymentMethod paymentMethod, TransactionDetails transactionDetails,
            BigDecimal transactionValue, String orderId) {
        super(DsmEventName.TransferToRegistrar, t);
    ...
    public TransferToRegistrar(Ticket t) {
        super(DsmEventName.TransferToRegistrar, t);
