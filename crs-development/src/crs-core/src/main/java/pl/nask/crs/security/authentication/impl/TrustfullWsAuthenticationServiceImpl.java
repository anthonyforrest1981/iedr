...
public class TrustfullWsAuthenticationServiceImpl extends AbstractWsAuthenticationService {
    ...
    public TrustfullWsAuthenticationServiceImpl(UserDAO userDAO, List<HashAlgorithm> algorithms,
    ...
    public AuthenticatedUser authenticate(String username, String password, boolean validateExpiration,
            ...
            throws InvalidUsernameOrPasswordException, LoginLockedException, PasswordExpiredException,
            NoLoginPermissionException {
        ...
        if ("locked".equalsIgnoreCase(password))
            throw new LoginLockedException(200);
    ...
    public AuthenticatedUser authenticateAndSwitchUser(String superUserName, String userName, String superUserPassword,
            ...
            throws InvalidUsernameOrPasswordException, LoginLockedException, NoLoginPermissionException,
            PasswordExpiredException, AccessDeniedException {
        try {
