...
public class BulkTransferIBatisDAO extends GenericIBatisDAO<BulkTransferRequest, Long> implements BulkTransferDAO {
    ...
    private static Map<String, String> sortingMap = new HashMap<>();
    {
        ...
        sortingMap.put("losingAccount", "losingAccount");
        sortingMap.put("losingAccountName", "losingAccountName");
        sortingMap.put("gainingAccount", "gainingAccount");
        sortingMap.put("gainingAccountName", "gainingAccountName");
        sortingMap.put("nh", "nh");
    }
    ...
    public boolean hasUnsettledReservations(String domainName) {
        Integer result = performQueryForObject("bulkTransfer.countUnsettledReservations", domainName);
