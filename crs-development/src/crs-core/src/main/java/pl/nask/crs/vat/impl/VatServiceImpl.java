...
public class VatServiceImpl implements VatService {
    ...
    @Override
    public int addVatRate(String category, Date from, BigDecimal vatRate, String username)
    ...
    private void validateDecimalPlace(Vat vatRate)
        ...
        for (DomainPrice domainPrice : prices) {
            DomainPriceValidator.validate(new ArrayList<>(list), domainPrice);
        }
    }
