...
public class AuthCodeEmailParameters implements EmailParameters {
    ...
    public List<ParameterName> getParameterNames() {
        return Arrays.<ParameterName>asList(ParameterNameEnum.DOMAIN, ParameterNameEnum.ADMIN_C_EMAIL,
                ParameterNameEnum.BILL_C_EMAIL, ParameterNameEnum.NIC_EMAIL, ParameterNameEnum.AUTHCODE,
