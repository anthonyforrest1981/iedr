...
public class ReauthoriseTransaction {
    ...
    public ReauthoriseTransaction(long id, OperationType operationType, String domainName, BigDecimal oldTotalCost,
            BigDecimal oldNetAmount, BigDecimal oldVatAmount, String orderId, BigDecimal newTotalCost,
            BigDecimal newNetAmount, BigDecimal newVatAmount, int periodInYears) {
        this.id = id;
