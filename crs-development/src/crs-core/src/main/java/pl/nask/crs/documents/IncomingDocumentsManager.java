...
public interface IncomingDocumentsManager {
    ...
    void deleteFile(DocumentFile documentFile)
    ...
    // public only for testing
    DocumentFile getDocumentFile(String fileName, DocumentFileType docFileType)
            throws NoSuchDirectoryException, WrongFaxFileExtensionException;
}
