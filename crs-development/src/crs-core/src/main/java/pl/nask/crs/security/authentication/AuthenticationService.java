...
public interface AuthenticationService {
     ...
     * @throws InvalidUsernameOrPasswordException the username is not found in the system
     ...
     */
    AuthenticatedUser authenticate(String username, String password, boolean validateExpiration,
