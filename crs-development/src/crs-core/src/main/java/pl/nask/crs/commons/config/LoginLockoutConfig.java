...
public class LoginLockoutConfig {
    ...
    public LoginLockoutConfig(GenericConfig genericConfig) {
        this.INITIAL_LOCKOUT_PERIOD = (Integer) genericConfig.getEntryOrThrowNpe("initial_lockout_period_seconds")
                .getTypedValue();
        this.LOCKOUT_INCREASE_FACTOR = (Integer) genericConfig.getEntryOrThrowNpe("lockout_increase_factor_seconds")
                .getTypedValue();
        this.MAXIMUM_LOCKOUT_PERIOD = (Integer) genericConfig.getEntryOrThrowNpe("maximum_lockout_period_seconds")
                .getTypedValue();
    }
