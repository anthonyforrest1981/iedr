...
public enum DocumentFileType {
    FAX_NEW(false, "fax"), FAX_ASSIGNED(true, "fax"), ATTACHMENT_NEW(false, "attachment"), ATTACHMENT_ASSIGNED(
            true,
            "attachment"), PAPER_NEW(false, "paper"), PAPER_ASSIGNED(true, "paper"), UPLOAD_VIA_MAIL(
            false,
            "attachment"), UPLOAD_VIA_CONSOLE(false, "attachment");
    ...
    public boolean isFaxType() {
        return this == FAX_NEW || this == FAX_ASSIGNED;
    }

    public boolean isAttachmentType() {
        return this == ATTACHMENT_NEW || this == ATTACHMENT_ASSIGNED || this == UPLOAD_VIA_CONSOLE
                || this == UPLOAD_VIA_MAIL;
    }

    public boolean isPaperType() {
        return this == PAPER_NEW || this == PAPER_ASSIGNED;
    }
