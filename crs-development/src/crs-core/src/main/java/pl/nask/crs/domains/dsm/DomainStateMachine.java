...
public interface DomainStateMachine {
     ...
     * @param eventName
     */
    void handleEvent(AuthenticatedUser user, Domain domain, DsmEvent event, OpInfo opInfo)
    ...
    void handleEvent(AuthenticatedUser user, String domainName, DsmEventName eventName, OpInfo opInfo)
            throws DomainIllegalStateException, DomainNotFoundException;

    void handleEvent(AuthenticatedUser user, String domainName, DsmEvent event, OpInfo opInfo)
            throws DomainIllegalStateException, DomainNotFoundException;
}
