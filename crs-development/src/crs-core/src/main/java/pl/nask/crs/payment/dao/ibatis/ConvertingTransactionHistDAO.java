 ...
 */
public class ConvertingTransactionHistDAO extends ConvertingGenericDAO<InternalTransaction, Transaction, Long>
        implements TransactionHistDAO {

    InternalTransactionHistIbatisDAO internalDAO;

    public ConvertingTransactionHistDAO(InternalTransactionHistIbatisDAO internalDAO,
            Converter<InternalTransaction, Transaction> internalConverter) {
