...
public class DocumentFile {
    ...
    private static final List<String> DEFAULT_TIFF_EXTENSIONS = Collections.unmodifiableList(Arrays.asList("tiff",
            "tif"));
    private static final List<String> DEFAULT_PICTURE_EXTENSIONS = Collections.unmodifiableList(Arrays.asList("jpg",
            "jpeg", "png", "bmp", "gif"));
