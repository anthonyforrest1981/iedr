...
public class HardcodedGenericConfig implements GenericConfig {
    ...
    public HardcodedGenericConfig() {
        ...
        addEntry("incoming_docs_path_fax_new", "/fax/new");
        addEntry("incoming_docs_path_fax_assigned", "/fax/assigned");
        addEntry("incoming_docs_path_attachment_new", "/attachment/new");
        addEntry("incoming_docs_path_attachment_assigned", "/attachment/assigned");
        addEntry("document_count_limit", 5);
        addEntry("document_size_limit_in_mb", 5);
