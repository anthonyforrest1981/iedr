...
public class EmailGroupAppServiceImpl implements EmailGroupAppService {
    ...
    public LimitedSearchResult<EmailGroup> search(AuthenticatedUser user, EmailGroupSearchCriteria searchCriteria,
    ...
    public List<EmailGroup> getAllGroups(AuthenticatedUser user) {
        return service.findEmailGroups(new EmailGroupSearchCriteria(),
                Collections.singletonList(new SortCriterion("id", true))).getResults();
    }
