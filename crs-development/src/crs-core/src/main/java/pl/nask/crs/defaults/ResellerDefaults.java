...
public class ResellerDefaults {
    ...
    public ResellerDefaults(String nicHandleId, String techContactId, List<String> newNameservers,
    ...
    public String toString() {
        return String
                .format("ResellerDefaults[nicHandleId=%s, techContact=%s, nameservers=[%s], dnsPeriod=%s, emailInvoiceType=%s]",
                        nicHandleId, techContactId, CollectionUtils.toString(nameservers, ", "), dnsNotificationPeriod,
                        emailInvoiceFormat);
    }
}
