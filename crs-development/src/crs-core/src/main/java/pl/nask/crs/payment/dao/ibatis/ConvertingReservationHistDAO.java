 ...
 */
public class ConvertingReservationHistDAO extends ConvertingGenericDAO<InternalReservation, Reservation, Long>
        implements ReservationHistDAO {

    InternalReservationHistIbatisDAO internalDAO;

    public ConvertingReservationHistDAO(InternalReservationHistIbatisDAO internalDAO,
