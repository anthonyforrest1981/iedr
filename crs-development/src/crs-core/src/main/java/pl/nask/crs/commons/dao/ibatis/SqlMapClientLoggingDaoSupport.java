...
public class SqlMapClientLoggingDaoSupport extends SqlMapClientDaoSupport {
    ...
    protected </*>>>@Nullable*/ T> T performQueryForObject(String queryId, Map<String, Object> parameterMap) {
        try {
            logQuery(queryId);
    ...
    protected </*>>>@Nullable*/ T> T performQueryForObject(String queryId, Object parameter) {
        try {
            logQuery(queryId);
    ...
    protected void logSqlError(String queryId, /*>>>@Nullable*/ Map parameterMap, Exception e) {
