...
public class DepositFundsExporter extends XmlExporter<DoaType> {
    ...
    public DepositFundsExporter(ApplicationConfig cfg, NicHandleSearchService nhService,
    ...
    public void exportDOA(String nicHandle, BigDecimal valueInStandardCurrencyUnit, Date date, String orderId)
    ...
    private OutputStream destinationFor(long nextId, Date date) throws ExportException {
        ...
        String formattedName = NameFormatter.getFormattedName(nextId, NameFormatter.NamePrefix.DOA,
    ...
    private DoaType convert(NicHandle nh, BigDecimal valueInStandardCurrencyUnit, long nextId, Date date, String orderId) {
        ...
        dt.setAmount(valueInStandardCurrencyUnit.doubleValue());
