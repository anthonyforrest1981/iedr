...
public class DepositCorrectionParams extends MapBasedEmailParameters {
    ...
    public DepositCorrectionParams(String orderId, BigDecimal roundedAndScaledValue, NicHandle nicHandle,
        ...
        set(ParameterNameEnum.TRANSACTION_VALUE, MoneyUtils.getRoundedAndScaledValue(roundedAndScaledValue, 2));
