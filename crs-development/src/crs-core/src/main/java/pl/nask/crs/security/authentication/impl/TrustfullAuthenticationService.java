...
public class TrustfullAuthenticationService implements AuthenticationService {
    ...
    public AuthenticatedUser authenticate(String username, String password, boolean validateExpiration,
            ...
            throws InvalidUsernameOrPasswordException, PasswordExpiredException, NoLoginPermissionException {
        ...
        if ("wrong".equals(username)) {
            ...
            loginAttemptDAO.createAttempt(LoginAttempt.newFailedInstance("wrong", "1.1.1.1", Cause.INVALID_NIC,
                    ++failedAttemptsCount));
