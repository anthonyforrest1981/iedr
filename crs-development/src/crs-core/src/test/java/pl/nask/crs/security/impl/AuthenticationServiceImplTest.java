...
public class AuthenticationServiceImplTest {
    ...
    public void init() {
        ...
        authService = new AuthenticationServiceImpl(mockDAO, Arrays.asList(mockAlgorithm), mockedAppConfig,
                loginAttemptDAO);
        ...
        expect(mockedAppConfig.getPasswordExpiryPeriod()).andStubReturn(10);
    ...
    private User createUserWithExpiredPassword() {
        ...
        Permission permission = new FullAccessPermission("fullAccess", "fullAccess");
        Set<Permission> permissions = new HashSet<>();
        permissions.add(permission);
        permissionGroups.add(new Group("HostmasterLead", permissions));
    ...
    private AuthenticatedUser authenticate(String user, String password, boolean validateExpiration)
    ...
    public void authenticateUserPasswordExpired() throws Exception {
        authenticate("IDL2-IEDR", "123456", true);
    }
