...
public class RegistrarPermissionsTest extends AbstractPermissionTest {
    ...
    private final static long OWN_ACCOUNT_ID = 262L;
    ...
    private final static long OWN_TICKET_ID = 257706;
    private final static long NOT_OWN_TICKET_ID = 401001;

    private final static String DOMAIN_NAME_FOR_OWN_TICKET = "listonmotorhomes.ie";
    ...
    private final static long OWN_TRANSACTION_ID = 101;
    private final static long NOT_OWN_TRANSACTION_ID = 6;
    private final static long OWN_TRANSACTION_HIST_ID = 70;
    ...
    private final static long OWN_BUY_REQUEST_ID = 13L;
    private final static long NOT_OWN_BUY_REQUEST_ID = 39L;

    private final static long OWN_SELL_REQUEST_ID = 13L;
    ...
    public void searchForNicHandles() throws AccessDeniedException {
        ...
        criteria.setAccountNumber(OWN_ACCOUNT_ID);
