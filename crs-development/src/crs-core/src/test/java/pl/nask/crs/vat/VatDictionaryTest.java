...
public class VatDictionaryTest extends AbstractTest {
    ...
    public void getEntryTest() {
        ...
        AssertJUnit.assertTrue(date1.after(vat.getFromDate()));
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.1), vat.getVatRate());

        vat = vatDictionary.getEntry("C");
        AssertJUnit.assertEquals("C", vat.getCategory());
        AssertJUnit.assertTrue(date1.after(vat.getFromDate()));
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.3), vat.getVatRate());

        vat = vatDictionary.getEntry("S");
        AssertJUnit.assertEquals("S", vat.getCategory());
        AssertJUnit.assertTrue(date1.after(vat.getFromDate()));
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.95), vat.getVatRate());
        ...
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.19), vat.getVatRate());

        vat = vatDictionary.getEntry("B");
        AssertJUnit.assertEquals("B", vat.getCategory());
        AssertJUnit.assertTrue(date2.after(vat.getFromDate()));
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.09), vat.getVatRate());

        vat = vatDictionary.getEntry("C");
        AssertJUnit.assertEquals("C", vat.getCategory());
        AssertJUnit.assertTrue(date2.after(vat.getFromDate()));
        AssertJUnit.assertEquals(MoneyUtils.getScaledVatValue(0.29), vat.getVatRate());
    ...
    public void getEntriesTest() {
        ...
        vat = new Vat(3, "A", new Date(125, 0, 1), MoneyUtils.getScaledVatValue(0.214));
        AssertJUnit.assertFalse("vat list does not contain vat: " + vat, vatList.contains(vat));
        vat = new Vat(5, "B", new Date(111, 1, 1), MoneyUtils.getScaledVatValue(0.1));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
        vat = new Vat(8, "C", new Date(111, 2, 1), MoneyUtils.getScaledVatValue(0.3));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
        vat = new Vat(11, "S", new Date(111, 3, 1), MoneyUtils.getScaledVatValue(0.95));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
        ...
        vat = new Vat(1, "A", new Date(110, 0, 1), MoneyUtils.getScaledVatValue(0.19));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
        vat = new Vat(4, "B", new Date(110, 1, 1), MoneyUtils.getScaledVatValue(0.09));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
        vat = new Vat(7, "C", new Date(110, 2, 1), MoneyUtils.getScaledVatValue(0.29));
        AssertJUnit.assertTrue("vat list does not contain vat: " + vat, vatList.contains(vat));
    }
