...
public class PaymentSenderTest {
    ...
    @Test
    public void sendingShouldFailIfNoUrlIsProvided() throws PaymentSenderException {
        try {
    ...
    @Test
    public void sendingShouldSucceedIfRealexIsRunning() throws PaymentSenderException {
