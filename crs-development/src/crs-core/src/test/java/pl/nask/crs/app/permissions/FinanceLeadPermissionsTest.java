...
public class FinanceLeadPermissionsTest extends AbstractPermissionTest {

    private final static String USER_NAME = "JB007-IEDR";
    private final static Level USER_LEVEL = Level.FinanceLead;
    ...
    public void getUser() throws AccessDeniedException {
        getUser(authenticatedUser, USER_NAME);
    }
