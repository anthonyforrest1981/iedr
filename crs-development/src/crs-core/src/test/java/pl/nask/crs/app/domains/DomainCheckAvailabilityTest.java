...
public class DomainCheckAvailabilityTest extends AbstractTransactionalTestNGSpringContextTests {
    ...
    @Test
    public void testDomainRegistered() throws AccessDeniedException {
    ...
    @Test
    public void testRegistrationPending() throws AccessDeniedException {
    ...
    @Test
    public void testAvailable() throws AccessDeniedException {
    ...
    @Test
    public void managedByRegistrarUserTest() throws AccessDeniedException {
    ...
    public void managedByDirectUserTest() throws Exception {
        AuthenticatedUser u = authenticationService.authenticate("AAG061-IEDR", "Passw0rd!", false, "1.1.1.1", false,
                null, true, "ws");
