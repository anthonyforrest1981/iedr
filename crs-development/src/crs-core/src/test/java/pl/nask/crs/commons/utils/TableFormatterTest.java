...
public class TableFormatterTest {
    ...
    public void testFormat() {
        ...
        initTable(formatter);
        for (int i = 0; i < 10; i++) {
            formatter.addDataLine(new Object[] {"domain.ie", "Domain holder name", 1, "Active", "OpType", new Date(),
                    new Date(), new BigDecimal(11.1100f)
    ...
    private void initTable(TableFormatter tableFormatter) {
        ...
        tableFormatter.addColumn("RegDt", 10, TableFormatter.dateYMDFormat(10), true);
        tableFormatter.addColumn("RenDt", 10, TableFormatter.dateYMDFormat(10), true);
