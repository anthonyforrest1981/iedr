...
public class ExceptionInterceptor extends ExceptionMappingInterceptor {
    ...
    public String intercept(ActionInvocation invocation) {
        ...
        try {
            ...
            if (mappedResult != null) {
                ...
                result = "error";
                publishException(invocation, new ExceptionMappingConfig.Builder("error", e.getClass()
                        .getCanonicalName(), result).build(), e);
            }
        }
    ...
    private void publishException(ActionInvocation invocation, ExceptionMappingConfig mappedResult, Exception e) {
    ...
    private ExceptionMappingConfig findMappingFromExceptions(List<ExceptionMappingConfig> exceptionMappings, Throwable t) {
