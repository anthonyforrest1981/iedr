...
public class ReportsSearchAction extends GenericSearchAction<AbstractTicketReport, ReportsSearchCriteria> {
    ...
    @Override
    protected TicketsPaginatedList<AbstractTicketReport> performSearch(ReportsSearchCriteria searchCriteria,
            TableParams tableParams, int pageSize) throws Exception {
        ...
        LimitedSearchResult<AbstractTicketReport> searchResult = reportsAppService.search(getUser(), searchCriteria,
