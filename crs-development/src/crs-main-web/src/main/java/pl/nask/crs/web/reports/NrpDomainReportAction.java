...
public class NrpDomainReportAction extends GenericSearchAction<Domain, DomainSearchCriteria> {
    ...
    private List<DomainHolderType> prepareHolderTypes() {
        return Arrays.asList(DomainHolderType.Billable, DomainHolderType.Charity, DomainHolderType.IEDRPublished,
                DomainHolderType.IEDRUnpublished, DomainHolderType.NonBillable);
    }
