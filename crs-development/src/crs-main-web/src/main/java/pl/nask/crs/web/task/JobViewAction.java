...
public class JobViewAction extends GenericSearchAction<Job, JobSearchCriteria> {
    ...
    protected TicketsPaginatedList<Job> performSearch(JobSearchCriteria criteria, TableParams tableParams, int pageSize)
            throws Exception {
        ...
        LimitedSearchResult<Job> searchResult = scheduler.findJobs(getUser(), criteria,
