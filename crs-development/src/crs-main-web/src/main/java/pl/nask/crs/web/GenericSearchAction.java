...
public abstract class GenericSearchAction<T, SEARCH_CRITERIA_TYPE extends SearchCriteria<? super T>> extends
    ...
    private List<SortCriterion> defaultSortBy;
    ...
    public void setDefaultSortBy(List<SortCriterion> defaultSortBy) {
    ...
    public String search() throws Exception {
        ...
        refreshSearch();
        clearSearchCriteria(); // feature #747
        return SUCCESS;
    }
    ...
    protected boolean getResetSearch() {
        return resetSearch;
    }
    ...
    protected TicketsPaginatedList<T> performSearch(SEARCH_CRITERIA_TYPE searchCriteria, TableParams tableParams,
        ...
        if (searchService == null)
            throw new IllegalStateException(
                    "searchService was not provided by the constructor, you must re-implement this method");
        LimitedSearchResult<T> searchResult = searchService.search(getUser(), searchCriteria,
                ((long) (tableParams.getPage() - 1)) * pageSize, pageSize, orderBy);
        return new TicketsPaginatedList<>(searchResult.getResults(), (int) searchResult.getTotalResults(),
    ...
    */
    ...
    public List<SortCriterion> getDefaultSortBy() {
