...
public class BulkTransferCreateAction extends AuthenticatedUserAwareAction {
    ...
    public BulkTransferCreateAction(AccountSearchService accountSearchService,
    ...
    public String create() throws AccessDeniedException {
        this.id = bulkTransferAppService.createBulkTransferProcess(getUser(), losingAccountId, gainingAccountId,
                remarks);
        return SUCCESS;
    }
