...
public class NicHandleResetPasswordAction extends AuthenticatedUserAwareAction implements ServletRequestAware {
    ...
    public String saveNewPassword() throws Exception {
        nicHandle = nicHandleAppService.saveNewPassword(getUser(), nicHandleId, newPassword1, newPassword2);
        return SUCCESS;
    }

    public String resetPassword() throws Exception {
        nicHandleAppService.resetPassword(getUser(), nicHandleId, ServletUtils.getRemoteIP(request));
        return SUCCESS;
    }
