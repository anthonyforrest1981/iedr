...
public class TicketViewAction extends TicketAction {
    ...
    protected TriplePassAppService triplePassAppService;

    public TicketViewAction(ApplicationConfig config) {
        super(config);
    }
    ...
    public void setTriplePassAppService(TriplePassAppService triplePassAppService) {
    ...
    public String techCheck() {
        try {
            triplePassAppService.performTechnicalCheck(getUser(), getId(), true);
