...
public class JobHistViewAction extends GenericSearchAction<Job, JobSearchCriteria> {
    ...
    protected TicketsPaginatedList<Job> performSearch(JobSearchCriteria searchCriteria, TableParams tableParams,
        ...
        LimitedSearchResult<Job> searchResult = scheduler.findJobsHistory(getUser(), searchCriteria,
                ((long) (tableParams.getPage() - 1)) * pageSize, pageSize, orderBy);
        return new TicketsPaginatedList<Job>(searchResult.getResults(), (int) searchResult.getTotalResults(),
