            ...
            <td width="50%">
                <n:group2 titleText="Nic Handle" cssIcon="group-icon-nichandle">
                    ...
                    <n:group2 titleText="VAT" cssIcon="group-icon-cash">
                         <n:field label="VAT No"><div class="showValue">${nicHandle.vatNo}</div></n:field>
            ...
            <td width="50%">
                ...
                <n:group2 id="contact-info-group" titleText="Contact" cssIcon="group-icon-contact">
                    <n:field label="E-mail">
                        <div class="showValue" data-idntooltip-field="true" data-idntooltip-type="Email">
                            <c:out value="${nicHandle.email}"/>
                        </div>
                    </n:field>
                    <n:field label="Address"><div class="showValue" style="white-space:pre-wrap;"><c:out value="${nicHandle.address}"/></div></n:field>
                    <n:field label="County"><div class="showValue">${nicHandle.county.name}</div></n:field>
                    <n:field label="Country"><div class="showValue">${nicHandle.country.name}</div></n:field>
                        ...
                        <div style="float:left;padding:0 5px 0 10%;">
                            <s:form name="nic_handle_form_2" theme="simple">
                                ...
                                <s:if test="%{hasPermission('nichandle.tfa.button')}">
                                    <s:submit value="T.F.A" action="nic-handle-tfa" disabled="%{hasNoAccessRecord()}" method="input" theme="simple"/>
                                </s:if>
