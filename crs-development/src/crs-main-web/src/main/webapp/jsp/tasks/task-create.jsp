...
<n:group2 titleText="Create task" cssIcon="group-icon-document">
    <s:form theme="simple">
        <center>
            ...
            <n:field label="Running Nic Handle" cssContainer="force-margin-left30 force-width30">
                <s:textfield name="taskWrapper.runningNicHandle"/>
            </n:field>
            <n:fielderror fields="taskWrapper.runningNicHandle" colspan="1"/>
        </center>
        <hr class="buttons"/>
        <center>
