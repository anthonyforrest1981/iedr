...
<s:form action="/documents-search.action" theme="simple" method="GET">
    <n:group2 titleText="Criteria" cssIcon="group-icon-search">
        ...
        <div style="height:26px;">
            ...
            <div style="float:left; width:33%">
                <div>
                    <n:field2 label="BuyRequest Id " labelJustify="right" tooltipGapHidden="true"
                              fieldEditable="true"
                              cssContainerStyle="padding-left:30%;" cssLabelStyle="float:left;width:40%;"
                              cssCtrlStyle="float:left;width:60%;">
                        <s:textfield name="documentSearchCriteria.buyRequestId" theme="simple" cssStyle="width:150px;text-indent:0;"/>
                    </n:field2>
                </div>
            </div>
            <div style="float:left; width:33%">
...
<nd:doclist buyRequestPreviousAction="documents-assigned"/>
</body>
</html>
