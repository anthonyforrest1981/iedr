...
<n:group2 titleText="Log new document:" cssIcon="group-icon-document">
    <s:form action="documents-nameUpdate" theme="simple">
        ...
        <center>
            ...
            <n:field label="Buy request" hideTooltipGap="true"
                     cssContainer="text-align-left force-width30" fielderror="document.buyRequestId">
                <s:textfield name="document.buyRequestId" value="%{#attr.document.buyRequestId}" label="BuyRequest"
                             disabled="false" theme="simple" cssStyle="width:100%;"/>
            </n:field>
