            ...
            <div style="float:left; width:50%">
                <div>
                    <n:field2 label="Suspension From" labelJustify="right" tooltipGapHidden="true"
                        ...
                        <n:datefield2 field="searchCriteria.suspensionFrom"/>
                    </n:field2>
                </div>
            </div>
            <div style="float:left; width:50%">
                <div>
                    <n:field2 label="To" labelJustify="right" tooltipGapHidden="true"
                        ...
                        <n:datefield2 field="searchCriteria.suspensionTo"/>
                    </n:field2>
                </div>
            </div>
        </div>
...
<n:group2 titleText="Result">
    <display:table name="paginatedResult" id="domainRow" class="result"
        ...
        <display:column title="Class" property="holderClass.name" sortable="true"/>
        <display:column title="Category" property="holderCategory.name" sortable="true"/>
        <display:column title="Country" property="firstAdminContact.countryName" sortable="false"/>
        <display:column title="County" property="firstAdminContact.countyName" sortable="false"/>
