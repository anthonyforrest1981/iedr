...
<n:group2 titleText="Results">
    <display:table name="paginatedResult" id="depositsRow" class="result"
        ...
        <display:column title="Reserved Funds" sortable="false" headerClass="force-text-right" class="force-text-right" property="reservedFunds" decorator="pl.nask.crs.web.displaytag.MoneyDecorator" media="csv xml"/>
        ...
        <display:column title="Available Balance" sortable="false" headerClass="force-text-right" class="force-text-right" property="closeBalMinusReservations" decorator="pl.nask.crs.web.displaytag.MoneyDecorator" />
