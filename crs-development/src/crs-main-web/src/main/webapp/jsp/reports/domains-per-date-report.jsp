                ...
                <div>
                    <n:field2 label="Class" labelJustify="right" tooltipGapHidden="true"
                        ...
                        <s:select list="classList" listKey="id" listValue="name"
                                  ...
                                  name="searchCriteria.holderClassId" value="searchCriteria.holderClassId"
                                  theme="simple" cssStyle="width: 150px;"/>
                    </n:field2>
                </div>
            </div>
                ...
                <div>
                    <n:field2 label="Category" labelJustify="right" tooltipGapHidden="true"
                        ...
                        <s:select list="categoryList" listKey="id" listValue="name"
                                  headerKey="" headerValue="[All]"
                                  name="searchCriteria.holderCategoryId" value="searchCriteria.holderCategoryId"
                                  theme="simple" cssStyle="width: 150px;"/>
                    </n:field2>
                </div>
            </div>
...
<n:group2 titleText="Result">
    <display:table name="paginatedResult" id="domainRow" class="result"
        ...
        <display:column title="Class" property="domainClass.name" sortable="true"/>
        <display:column title="Category" property="domainCategory.name" sortable="true"/>
        ...
        <display:column media="html">
            <s:url var="viewDomainsUrl" action="domains-list" includeParams="none">
                ...
                <s:param name="searchCriteria.holderClassId">${domainRow.domainClass.name}</s:param>
                <s:param name="searchCriteria.holderCategoryId">${domainRow.domainCategory.name}</s:param>
