...
<n:group2 titleText="Ticket Status" cssIcon="group-icon-status">
    ...
    <n:field2 label="Type">${ticket.operation.type.fullName}</n:field2>
...
<n:group2 id="domain-info-group" titleText="Domain" cssIcon="group-icon-domain">
    ...
    <c:set var="relatedDomains" value="${htmlutils:displayListAsTable(info.relatedDomainNames, 3, null)}${htmlutils:displayListAsTable(info.pendingDomainNames, 3, \"pending-domain-names\")}"/>
    ...
    <div class="ctrl-container force-height-triple">
        <div class="ctrl-label">
            ...
            <div class="ctrl-tooltip">&nbsp;</div>
            <div class="ctrl-label-inner2" style="padding-left:8px">Subcategory</div>
        </div>
        <div class="ctrl-field">
            <div class="ctrl-field-inner">
                <n:holderentities
                        id="ticketEditHolderEntities"
                        classList="ticketClasses"
                        categoryList="ticketCategories"
                        classField="ticketWrapper.domainHolderClass.id"
                        classCssClass="${ticketWrapper.domainHolderClass.modification ? 'modification' : null}"
                        categoryField="ticketWrapper.domainHolderCategory.id"
                        categoryCssClass="${ticketWrapper.domainHolderCategory.modification ? 'modification' : null}"
                        subcategoryField="ticketWrapper.domainHolderSubcategory.id"
                        subcategoryCssClass="${ticketWrapper.domainHolderSubcategory.modification ? 'modification' : null}" />
            </div>
    ...
    <n:fielderror fields="ticketWrapper.domainHolderCategory.id" colspan="1"/>
