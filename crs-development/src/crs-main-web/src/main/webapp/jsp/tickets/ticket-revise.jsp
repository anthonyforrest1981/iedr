    ...
    <td width="50%">
        ...
        <n:group2 id="domain-info-group" titleText="Domain" cssIcon="group-icon-domain">
            ...
            <ticket:tickettextfield2 label="Category"
                                            ...
                                            fieldSuffix="name"
                      />
            <n:field2 label="Subcategory" cssCtrlStyle="width: 50%;" >
                <s:if test="ticketWrapper.domainHolderCategory.subcategories.size() > 0">
                    <s:select list="ticketWrapper.domainHolderCategory.subcategories" listKey="id" listValue="name"
                            headerKey="" headerValue=""
                            cssClass="%{ticketWrapper.domainHolderSubcategory.modification ? 'modification' : ''}"
                            style="width: 84%;">
                        <s:param name="value">${ticketWrapper.domainHolderSubcategory.id}</s:param>
                        <s:param name="name">ticketWrapper.domainHolderSubcategory.id</s:param>
                    </s:select>
                </s:if>
            </n:field2>
