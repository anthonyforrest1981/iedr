...
<div class="FC">
    <div class="FCL default-label-width">
        <div class="FCB-box tooltip-gap">
            <div class="FCL-value textOnly justify-left">Country</div>
        </div>
    </div>
    <div class="FCB default-label-gap">
        <div class="FCB-reason">
            <div class="FCB-value">
                <s:select list="reasonsList" headerKey="null" headerValue="(none)"
                          listValue="description" theme="simple">
                    <s:param name="name">failures.adminCountyFR</s:param>
                    <s:param name="value">${failures.adminCountyFR}</s:param>
                </s:select>
            </div>
        </div>
...
<div class="FC">
    <div class="FCL default-label-width">
        <div class="FCB-box tooltip-gap">
            <div class="FCL-value textOnly justify-left">County</div>
        </div>
    </div>
    <div class="FCB default-label-gap">
        <div class="FCB-reason">
            <div class="FCB-value">
                <s:select list="reasonsList" headerKey="null" headerValue="(none)"
                          listValue="description" theme="simple">
                    <s:param name="name">failures.adminCountryFR</s:param>
                    <s:param name="value">${failures.adminCountryFR}</s:param>
                </s:select>
            </div>
        </div>
        <div class="FCB-box reason-gap">
