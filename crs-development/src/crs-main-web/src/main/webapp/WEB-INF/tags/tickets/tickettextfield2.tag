...
<%
    ...
    String reasonID = field + ".failureReason";
    FailureReason n = (FailureReason) jspContext.getVariableResolver().resolveVariable(reasonID);
            ...
            <div class="<%=ctrlBoxClass%>">
                <% if (fieldEditable) { %>
                    <div class="<%=ctrlValueClass%>">
                        <input id="<%= fieldID%>" type="text" value="<%= fieldValue%>" name="<%= fieldName %>"<%= idnTooltipFieldsAttributes %>/>
                    </div>
                <% } else { %>
                    <div class="<%=ctrlValueClass%>"<%= idnTooltipFieldsAttributes %>>
                        <%= fieldValue%>
                    </div>
                <% } %>
            </div>
