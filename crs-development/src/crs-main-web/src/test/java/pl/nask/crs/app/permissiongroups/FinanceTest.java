...
public class FinanceTest extends AbstractPermissionGroupTest {
    ...
    public void setUp() throws Exception {
        finance = authenticationService.authenticate("AAG45-IEDR", "Passw0rd!", false, "1.1.1.1", false, null, true,
                "ws");
    }
    ...
    public void viewTicketHistory() throws Exception {
        viewTicketHistory(finance);
    }

    @Test(expectedExceptions = AccessDeniedException.class)
    public void reviseTicket() throws Exception {
        reviseTicket(finance);
    }
