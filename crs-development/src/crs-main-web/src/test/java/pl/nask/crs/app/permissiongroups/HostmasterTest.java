...
public class HostmasterTest extends AbstractPermissionGroupTest {
    ...
    public void setUp() throws Exception {
        hostmaster = authenticationService.authenticate("AAA906-IEDR", "Passw0rd!", false, "1.1.1.1", false, null,
                true, "crs");
    }
    ...
    @Test(expectedExceptions = AccessDeniedException.class)
    public void saveNicHandleOwnAccountViolation() throws Exception {
        saveNicHandleOwnAccountViolation(hostmaster);
    }
