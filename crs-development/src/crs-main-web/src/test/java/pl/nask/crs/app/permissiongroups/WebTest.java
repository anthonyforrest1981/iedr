...
public class WebTest extends AbstractPermissionGroupTest {
    ...
    private static final String VALID_NH = "APITEST-IEDR";

    private static final String VALID_DN = "z.ie";

    private static final long VALID_TICKET = 259928;

    AuthenticatedUser web;

    @BeforeMethod
    public void setUp() throws Exception {
        web = authenticationService.authenticate(VALID_NH, "Passw0rd!", false, "1.1.1.1", false, null, true, "ws");
    }
    ...
    public void saveNicHandle() throws Exception {
        saveNicHandleOwnAccount(web, VALID_NH);
    }
    ...
    @Test
    public void createNicHandleOwnAccount() throws Exception {
        createNicHandleOwnAccount(web, VALID_NH);
    }
