...
public class ResellerTest extends AbstractPermissionGroupTest {
    ...
    public void setUp() throws Exception {
        reseller = authenticationService.authenticate("AAH296-IEDR", "Passw0rd!", false, "1.1.1.1", false, null, true,
                "ws");
    }
    ...
    public void saveNicHandle() throws Exception {
        saveNicHandleOwnAccount(reseller, VALID_NH);
    }
    ...
    public void createNicHandleOwnAccount() throws Exception {
        createNicHandleOwnAccount(reseller, VALID_NH);
    }
