...
public class SecDnsTest {
    ...
    @Test
    public void unmarshallDomainCreate() throws IOException, CommandSyntaxErrorException, CommandFailed {
    ...
    public void marshallDomainInfo() throws JAXBException {
        ...
        String s = m.marshall();
        AssertJUnit.assertTrue("msg should contain 'secDNS:infData', but it doesn't: " + s,
                s.contains("secDNS:infData"));
    }
}
