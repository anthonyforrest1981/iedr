...
public class MyMarshaller {
    ...
    static {
        ...
        addUri(Constants.IEAPI_BUY_REQUEST_NAMESPACE, "ieapi-registrantTransferBuyRequest");
        addUri(Constants.IEAPI_SELL_REQUEST_NAMESPACE, "ieapi-registrantTransferSellRequest");
    ...
    private Marshaller prepareGlobalMarshaller() throws JAXBException {
        ...
        m.setProperty("jaxb.formatted.output", true);
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, Constants.IEAPI_NAMESPACE + " "
                + getSchemaForUri(Constants.IEAPI_NAMESPACE));
        m.setProperty("com.sun.xml.bind.namespacePrefixMapper", prefixMapper);
        ValidationEventHandler validationEventHandler = new MyValidationEventHandler();
        m.setEventHandler(validationEventHandler);
        return m;
