...
import ie.domainregistry.ieapi_1.*;
...
public final class ResponseTypeFactory {
    ...
    private static final ie.domainregistry.ieapi_domain_1.ObjectFactory domainFactory =
            new ie.domainregistry.ieapi_domain_1.ObjectFactory();
    private static final ie.domainregistry.ieapi_ticket_1.ObjectFactory ticketFactory =
            new ie.domainregistry.ieapi_ticket_1.ObjectFactory();
    private static final ie.domainregistry.ieapi_account_1.ObjectFactory accountFactory =
            new ie.domainregistry.ieapi_account_1.ObjectFactory();
    private static final ie.domainregistry.ieapi_registranttransferbuyrequest_1.ObjectFactory buyRequestFactory =
            new ie.domainregistry.ieapi_registranttransferbuyrequest_1.ObjectFactory();
    private static final ie.domainregistry.ieapi_registranttransfersellrequest_1.ObjectFactory sellRequestFactory =
            new ie.domainregistry.ieapi_registranttransfersellrequest_1.ObjectFactory();
    ...
    /**
     * Creates a response with the given response code and the valid response message. No resData or tid is set,
     * resultType contains only a responseCode and the response message
     */
    ...
    public static ResponseType success(ie.domainregistry.ieapi_registranttransferbuyrequest_1.RequestType res) {
        return successWithValues(buyRequestFactory.createRequestData(res));
    }

    public static ResponseType success(ie.domainregistry.ieapi_registranttransferbuyrequest_1.ResDataType res) {
        return successWithValues(buyRequestFactory.createResData(res));
    }

    public static ResponseType success(ie.domainregistry.ieapi_registranttransferbuyrequest_1.InfoDataType res) {
        return successWithValues(buyRequestFactory.createInfoData(res));
    }

    public static ResponseType success(ie.domainregistry.ieapi_registranttransfersellrequest_1.RequestType res) {
        return successWithValues(sellRequestFactory.createRequestData(res));
    }

    public static ResponseType success(ie.domainregistry.ieapi_registranttransfersellrequest_1.ResDataType res) {
        return successWithValues(sellRequestFactory.createResData(res));
    }

    public static ResponseType success(ie.domainregistry.ieapi_registranttransfersellrequest_1.InfoDataType res) {
        return successWithValues(sellRequestFactory.createInfoData(res));
    }

    public static ResponseType createResponse(int resultCode, ReasonCode reasonCode, String reasonMessage,
            Value value) {
        ...
        if (value != null) {
            ...
            errValue.getContent().add(
                    new JAXBElement<String>(new QName(value.getNamespace(), value.getTag(), ""), String.class, null,
                            value.getValue()));
